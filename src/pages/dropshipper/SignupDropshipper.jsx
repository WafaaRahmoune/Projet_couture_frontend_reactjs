...
export default function SignupDropshipper() {
  ...
  break;
      ...
      case "storeLink":
        if (!value.trim()) {
          ...
          error = "يجب أن يبدأ رابط المتجر بـ http:// أو https://";
        } else if (!isValidURL(value)) {
          error = "رابط المتجر غير صحيح";
        }
        break;
    }
    return error;
      ...
      if (error.response) {
        ...
        switch (status) {
          case 400:
            ...
            } else if (data.store_link) {
              setErrors((prev) => ({ ...prev, storeLink: Array.isArray(data.store_link) ? data.store_link[0] : data.store_link }));
      ...
      <div className="registration-card">
        <div className="registration-card-content">
          ...
          <div className="registration-header">
            <h2 className="registration-title">تسجيل حساب دروبشيبر</h2>
          </div>
...
/>
               <InputField
                ...
                onChange={(val) => handleInputChange("storeLink", val)}
