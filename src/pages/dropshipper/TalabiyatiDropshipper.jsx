...
function TalabiyatiDropshipper() {
  ...
  if (apiData.standard_orders && apiData.standard_orders.length > 0) {
    apiData.standard_orders.forEach(order => {
      ...
      transformedCommandes.push({
        ...
        variants: variants,
        isCustom: false,
        dropshipperClientName: order.dropshipper_client_name // Ajoute cette ligne
          ...
          {commandes.length === 0 ? (
            ...
            commandes.map((cmd) => (
              <CommandCard
                ...
                dropshipperClientName={cmd.dropshipperClientName} // Ajoutez cette ligne
...
export default TalabiyatiDropshipper;
