...
export default function NotActiveDropshipper() {
          ...
          <div className="login-success-content" dir="rtl">
            ...
            <div className="space-y-4 text-center">
              <p className="text-lg font-[Cairo] font-medium">
                عذراً، حالة حسابك كدروبشيبر غير نشطة حالياً
              </p>
              ...
              <ul className="text-[#374151] text-right list-inside list-disc  pr-5 space-y-2">
                <li>عدم الاستفادة من عروض الموديلات المقدمة للدروب شيبينغ</li>
                <li>عدم النشاط الكافي في المتجر والمبيعات</li>
                <li>المبيعات غير كافية للاستمرار كشريك في الموقع</li>
              </ul>
              ...
              <p className="text-[#374151]">
               ...
               على الرقم 
                ...
                <br />
                يمكنك استئناف العمل معنا كموزع نشط بعد التواصل مع الإدارة.
              </p>
            </div>
